...
fn play_round(monkeys: &mut Vec<Monkey>, very_worried: bool, worry_divisor: i64) {
...
fn main() {
    ...
    {
        let (_, mut monkeys) = monkeys(&input).expect("Failed to parse monkey business");
